...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_BLOCK = registerBlock("pink_garnet_block",
            new Block(AbstractBlock.Settings.create().strength(0.5f).requiresTool().sounds(BlockSoundGroup.AMETHYST_BLOCK)));
    public static final Block RAW_PINK_GARNET_BLOCK = registerBlock("raw_pink_garnet_block",
            new Block(AbstractBlock.Settings.create().strength(0.25f).requiresTool().sounds(BlockSoundGroup.NETHERRACK)));
    public static final Block FOSSIL_ROCK_BLOCK = registerBlock("fossil_rock_block",
            new Block(AbstractBlock.Settings.create().strength(0.2f).requiresTool().sounds(BlockSoundGroup.STONE)));
